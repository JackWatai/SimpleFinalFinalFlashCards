...
public class Topic4 extends AppCompatActivity
    ...
    private Question[] questionBank = new Question[] {
            ...
            new Question(R.string.n, true),
            new Question(R.string.o, false),
            new Question(R.string.p, false),
            new Question(R.string.q, false),
    ...
    private void checkAnswer(boolean userChooseCorrect)
    {
        ...
        Toast
                .makeText(Topic4.this, toastMessageId,
                        Toast.LENGTH_SHORT)
                .show();
    }
}